    ...
    <>
      <div className="space-y-6 pb-20">
        ...
        <div className="space-y-3 pt-4">
          {!canGenerate ? (
            <p className="text-xs text-foreground/60">
              Upload a garment photo, choose the garment type, and pick an environment and model to generate.
            </p>
          ) : null}
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
            <Button
              ...
              radius="lg"
              size="lg"
              className="h-12 w-full text-sm font-semibold sm:w-auto sm:min-w-[200px]"
