...
export default function Home() {
  ...
  function computeEffectivePrompt(poseOverride, forPreview = true) {
    ...
    lines.push(`- Person: ${usingPersonImage ? "" : (options.gender || "")}`);
    ...
    if (usingPersonImage) {
      ...
      lines.push("- No person reference: synthesize a plausible model matching the selected person; friendly neutral expression.");
      if (usingPersonDesc) {
